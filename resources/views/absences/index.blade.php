...
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('absences.create') }}" class="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700">
            Record New Absence
        </a>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">{{ $absence->student->name }}</td>
                    <td class="px-6 py-4 whitespace-nowrap">{{ $absence->class->name }}</td>
                    <td class="px-6 py-4 whitespace-nowrap">{{ $absence->subject->name }}</td>
                    <td class="px-6 py-4 whitespace-nowrap">{{ ucfirst(str_replace('_', ' ', $absence->period)) }}</td>
